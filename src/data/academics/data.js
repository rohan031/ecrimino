export const masters = {
	...
	parts: [
		...
		},
		{
			...
			text: "Concevoir un mécanisme de portée nationale, régionale ou internationale susceptible de contribuer à l'instauration d'une paix durable.",
			image: "/events/events1.WebP",
			link: "/documents/docs/Votre%20Ma%C3%AEtrise%20en%20criminologie%20%C3%A0%20l_Universit%C3%A9%20de%20Kinshasa.pdf",
		},
		{
		...
		},
		{
			...
			text: "Identifier et expliquer les situations problèmes dans les différents secteurs de la société congolaise, qu'elles soient criminalisées ou non, ainsi que les modalités de leur gestion en tenant compte de leurcomplexité",
			image: "/events/events1.WebP",
			link: "/documents/docs/Votre%20Ma%C3%AEtrise%20en%20criminologie%20%C3%A0%20l_Universit%C3%A9%20de%20Kinshasa.pdf",
		},
		],
...
export const phd = {
	...
	// "	{
	// 		heading: "Lorem Ipsum",
	// 		text: "L’École de criminologie et le Centre de criminologie et de pathologie sociale (CCPS), qui lui est rattaché, entendent produire des recherches fondamentales et des recherches appliquées. La recherche fondamentale est assurée par l’encadrement des doctorants, par les travaux des membres de l’École,",
	// 		image: "/events/events1.WebP",
...
export const certifications = {
	...
	parts: [
		{
			heading: "Formations certifiantes et renforcement des capacités",
			text: "L’École assure également des formations certifiantes en : - Gouvernance de la sécurité ; - Gouvernance économique ; - Paix et gouvernance. Ces formations donnent lieu à la délivrance d’un Certificat d’Université.",
			image: "/events/events1.WebP",
			link: "/documents/docs/ECOCRIM%20DEPLIANT.pdf",
		},
	],
